...
class ClaudeCodeServer(HTTPMCPServer):
    ...
    async def _setup_tools(self):
        ...
        self.register_tool(
            "generate_code",
            description="Generate code using Claude Code's advanced capabilities",
            parameters={
                "type": "object",
                "properties": {
                    "prompt": {
                    ...
                    "framework": {
                        "type": "string",
                        "description": "Framework or library context (optional)",
                    },
                },
                "required": ["prompt"],
            },
        ...
        self.register_tool(
            "analyze_code",
            description="Analyze existing code for bugs, improvements, or explanations",
            parameters={
                "type": "object",
                "properties": {
                    ...
                    "analysis_type": {
                        "type": "string",
                        "description": "Type of analysis: 'review', 'debug', 'explain', 'optimize'",
                        "default": "review",
                    },
                },
                "required": ["code"],
        ...
        self.register_tool(
            "scaffold_project",
            description="Create project structure and boilerplate code",
            parameters={
                "type": "object",
                "properties": {
                    "project_type": {
        ...
        self.register_tool(
            ...
            description="Get information about Claude Code capabilities and status",
            parameters={"type": "object", "properties": {}, "required": []},
            handler=self._get_claude_code_info,
        )

    async def _generate_code(
        self, prompt: str, language: str = "python", framework: str = None
    ) -> str:
    ...
    async def _scaffold_project(
        self, project_type: str, project_name: str, features: list = None
    ) -> str:
    ...
    def _fallback_code_generation(
        self, prompt: str, language: str, framework: str
    ) -> str:
...
"""
    ...
    def _fallback_project_scaffold(
        self, project_type: str, project_name: str, features: list
    ) -> str:
