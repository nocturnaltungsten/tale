...
class ConversationTurn:
    ...
    def __init__(self, user_input: str, response: str, task_id: str | None = None):
...
class ConversationState:
    ...
    def add_turn(self, user_input: str, response: str, task_id: str | None = None):
...
Assistant:"""
            ...
            self.conversation_state.add_turn(message, response["reply"])
    ...
    def _generate_progress_message(self, status: str, result: dict) -> str:
