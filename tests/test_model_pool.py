...
from tale.models.model_pool import ModelClient, ModelPool
from tale.models.ollama_client import OllamaClientError
...
class TestModelPoolIntegration:
    ...
    async def test_model_pool_import_functionality(self):
        ...
        try:
            from tale.models.model_pool import ModelPool
